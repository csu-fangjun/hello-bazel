# refer to
#   https://github.com/bazelbuild/bazel/wiki/Building-with-a-custom-toolchain#writing-the-build-file-for-the-new-repository

# used by WORKSPACE to turn the cross compiler tool chain
